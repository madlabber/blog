...
last_modified_at: 2019-06-24 06:35:16 -0000
publish: true
pin: false
categories:
- Uncategorized
...
- Windows
---
This should be a simple task. I have already [created the answer file for an unattended installation](https://madlabber.wordpress.com/2019/06/19/using-autounattend-xml-to-enable-ansible-support-in-windows/), copied it to a [virtual floppy image](https://madlabber.wordpress.com/2019/06/13/how-to-create-floppy-disk-images-on-macos/), and obtained a windows installation ISO. [VMware's Ansible modules](https://docs.ansible.com/ansible/latest/modules/list_of_cloud_modules.html#vmware) look promising, so you would think you could use vsphere_copy to transfer the .iso and .flp to a datastore, use vsphere_guest to create the VM, and sit back and wait for WinRM to start responding.
...
You can find the complete playbook on the [madlabber github](https://github.com/madlabber/NewWindowsVM-Ansible), but here are some of the highlights:
...
One more reboot and the VM is ready for advanced configuration by another playbook. In the [complete playbook](https://github.com/madlabber/NewWindowsVM-Ansible/blob/master/NewWindowsVM.yml) and the corresponding [example vars file](https://github.com/madlabber/NewWindowsVM-Ansible/blob/master/NewWindowsVM-vars.yml), there are a few extra steps I take to capture and later restore the state of the TSM & TSM-SSH services since most people don't leave those enabled.
